...
export const Index = () => {
  const steps = [
    ...
    {
      title: "6. Geser Motif ke Bagian Pakaian",
      desc: "Drag (geser) motif batik ke sisi pakaian yang kamu inginkan. Misalnya, letakkan motif di sisi depan pakaian atau hanya di lengan. Kamu bebas mengatur sesuai kreativitasmu.",
      img: "/steps/step-5.png"
    },
    {
      title: "7. Terapkan Motif ke Model 3D",
    ...
    {
      title: "8. Ulangi atau Ganti Desain",
    ...
    <div>
      <div className="flex justify-start">
        <button 
          ...
          className="text-slate-300 font-normal flex gap-3 text-lg md:text-2xl items-center opacity-50 hover:opacity-100 transition-all duration-300"
        >
          <ArrowLeft/> Kembali
        </button>
      </div>
      ...
      <div className="content py-10 md:py-20 text-center flex justify-center flex-col">
        <BlurText className="font-bold text-4xl md:text-6xl text-center lg:mx-auto" text="Tutorial" delay={1000}/>
        <BlurText className="font-light text-slate-300 mt-4 text-base md:text-lg mx-auto" text="Ikuti langkah-langkah berikut untuk menggunakan halaman 3D interaktif."/>
      </div>
        ...
        {steps.map((step, i) => (
          ...
          >
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl md:text-3xl font-semibold mb-3">{step.title}</h2>
